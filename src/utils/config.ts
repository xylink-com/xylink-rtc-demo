...
// 服务地址，默认使用正式环境
export const SERVER = 'st52webrtc.xylinkedu.com:8443';
...
export const ACCOUNT = {
  extId: "d7cbd71acd5811ed87f1525400c140b2",
  clientId: "kEqrbDIrHEOwzzAuNx8xmZbC",
  clientSecret: "E173GCxLkSudv8Bg3ey7EaNl7Y6SOr9q",
};